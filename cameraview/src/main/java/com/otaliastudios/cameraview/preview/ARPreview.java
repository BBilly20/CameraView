...
public class ARPreview extends GlCameraPreview {
    ...
    public void setFilter(final @NonNull Filter filter) {
        super.setFilter(getFilter(filter));
    }
    ...
    public class ARRenderer extends GlCameraPreview.Renderer{
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            if (mCurrentFilter == null) {
                mCurrentFilter = getFilter(new NoFilter());
            }
...
//            GLES20.glViewport(0, 0, width, height); //called by super
